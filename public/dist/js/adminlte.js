...
function confirmDelete1() {
    if (confirm("Bạn có chắc chắn muốn xóa tài khoản này không?")) {
        // Nếu người dùng xác nhận xóa, thực hiện xóa tài khoản ở đây
        return true
    } else {
        // Nếu người dùng không xác nhận xóa, không làm gì cả hoặc có thể thực hiện một hành động khác tùy ý
